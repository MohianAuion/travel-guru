          ...
          {!light && (
            ...
            <div className="relative">
              ...
              <input
                ...
                className="input pr-10 pl-9 w-64 text-white font-semibold bg-gray-300/50 text-sm"
              />
          ...
          {!light && (
            ...
            <div className="relative w-full mb-4">
              ...
              <input
                type="text"
                placeholder="Search Destination"
                className="input pr-10 pl-9 w-full text-black font-semibold bg-gray-100 text-sm"
              />
